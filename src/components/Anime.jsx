...
export class AnimationFromSVG extends Component {
    ...
    render() {
        ...
        const svgData = svgContent ? this.parseSVG(svgContent, color, duration, strokeWidth, strokeLength) : { paths: null, viewBox: "0 0 200 200", defaultWidth: '100%', defaultHeight: '100%' };
